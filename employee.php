...
$receipts = query("SELECT users.phone_number, orders.time, orders.id  FROM `orders` 
          ...
          <div class="card card-primary card-outline">
            <div class="card-body box-profile">
              <div class="text-center">
                <img class="profile-user-img img-fluid img-circle" style="object-fit: cover; width: 100px; height: 120px;" src="public/images/employee/<?= $employee[0]['image'] ?>" alt="User profile picture">
              </div>
              ...
              <ul class="list-group list-group-unbordered mb-3">
                <li class="list-group-item">
                  ...
                  <b>Đánh giá</b> <a class="float-right"><?= $vote[0]["vote"] ?><i class="fas fa-star"></i></a>
                </li>
                <li class="list-group-item">
              ...
              <a href="#" class="btn btn-primary btn-block"><b>Xin nghỉ</b></a>
            </div>
            <!-- /.card-body -->
          </div>
          <!-- /.card -->
                ...
                <tbody>
                  <?php foreach ($receipts as $key => $receipt) : ?>
                    <tr>
                      ...
                      <td>
                        <a href="/employee.php?detail=<?= $receipt['id'] ?>"><button class="badge bg-success" style="border: none;">Detail</button></a>
                      </td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
