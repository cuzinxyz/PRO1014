            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <?php if (isset($_GET['detail'])) : ?>
                        <!--Kiểm tra xem đang ở trạng thái chi tiết hay đã thanh toán-->
                        <?php if (isset($_GET['done'])) : ?>
                            <div class="row justify-content-center py-2">
                                <h1>Cảm ơn quý khách đã sử dụng dịch vụ của chúng tôi.</h1>
                            </div>
                            <div class="row justify-content-center py-3">
                                <div class="feedback">
                                    <form action="" method="post">
                                        ...
                                        <textarea class="form-control" name="feedback_content" rows="3" placeholder="Nhập ghi chú (Tùy chọn) ..."></textarea>
                                        <button type="submit" class="mt-2 btn btn-block bg-gradient-success btn-xs">Send</button>
                                    </form>
                                </div>
                            </div>
                        <?php else : ?>
                            ...
                            ?>
                                <div class="text-center">
                                    <a href="/?action=receipt&detail=<?= $_GET['detail'] ?>&done">
                                        <button type="button" class="btn btn-block bg-gradient-success btn-sm">Đã thanh toán <i class="fas fa-check"></i></button>
                                    </a>
                                </div>
                            <?php
                            }
                            ...
                            <?php if ($detail['TrangThai'] == 4) : ?>
                                <a href="/?action=update_receipt&receipt=<?= $_GET['detail'] ?>"><button class="btn btn-primary btn-xs">Thêm dịch vụ</button></a>
                            <?php endif; ?>
                        <?php endif; ?>
                        <!--Kết thúc kiểm tra xem ở trạng thái done hay detail-->

                        <!--                    Nếu không có detail sẽ hiển thị danh sách các hóa đơn-->
                    <?php else : ?>
                        <div class="card">
                            <div class="card-header">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/?action=receipt&detail=<?= $receipt['MaHoaDon'] ?>">
                                                        <button type="button" class="btn btn-block btn-primary btn-xs">Xem Chi Tiết</button>
                                                    </a>
                                                    <?php if ($receipt['TrangThai'] != 2 && $receipt['TrangThai'] != 1) : ?>
                                                        <?php if ($receipt['TrangThai'] != 4) : ?>
                                                            <a href="/?action=receipt&confirm=<?= $receipt['MaHoaDon'] ?>">
                                                                <button type="button" class="btn btn-block btn-success btn-xs">Xác nhận</button>
                                                            </a>
                                                        <?php endif; ?>
                                                        <?php if ($receipt['TrangThai'] != 3) : ?>
                                                            <a href="/?action=receipt&cancel=<?= $receipt['MaHoaDon'] ?>">
                                                                <button type="button" class="btn btn-block btn-danger btn-xs">Hủy đơn</button>
                                                            </a>
                                                        <?php endif; ?>
                                                    <?php endif; ?>
                                                </td>
