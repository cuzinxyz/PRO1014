                    ...
                    <div class="row justify-content-center py-3">
                        <div class="feedback">
                            <form action="" method="post">
                                ...
                                <textarea class="form-control" name="feedback_content" rows="3"
                                    placeholder="Nhập ghi chú (Tùy chọn) ..."></textarea>
                                <button type="submit"
                                    class="mt-2 btn btn-block bg-gradient-success btn-xs">Send</button>
                            </form>
                        </div>
                    </div>
                    <?php else : ?>
        ...
        ?>
                    ...
                    <div class="text-center">
                        <a href="/?action=receipt&detail=<?= $_GET['detail'] ?>&done">
                            <button type="button" class="btn btn-block bg-gradient-success btn-sm">Đã thanh toán <i
